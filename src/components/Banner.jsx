...
export default function Banner() {
  return (
    <>
      <section
        className="z-0 bg-[#0a192f] text-white overflow-x-hidden p-4 lg:px-20"
        id="header"
      >
        <div className="   ">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="w-full lg:w-1/2">
              ...
              <h1
                data-aos="fade-up"
                data-aos-delay="1000"
                className="text-4xl lg:text-6xl  leading-tight font-bold gradient-text mt-6"
              >
              ...
              <div className="">
                ...
                <div className="flex   space-x-4 mt-6 lg:mt-0">
                  <a
                    ...
                    href="https://github.com/hasanali207/"
                  >
                    <FaGithub />
                  </a>
                  <a
                    className="text-2xl text-white"
                    href="https://www.linkedin.com/in/hasanali207/"
                  >
                    <FaLinkedin />
                  </a>
                  <a
                    className="text-2xl text-white"
                    href="https://www.facebook.com/hasanali142228/"
                  >
                    <FaFacebookSquare />
                  </a>
                </div>
            ...
            <div
              ...
              data-aos-delay="400"
              className="flex items-center mt-20 lg:mt-0 "
            >
              <div className="hero-image flex justify-center items-center ">
                <img
                  src={heroimage}
                  alt="profile-pic gradient-border"
