  ...
  return (
    <section className="p-10 bg-[#0a192f] section sec2 about" id="about">
      ...
      <div className="about-container grid grid-cols-1 lg:grid-cols-2 gap-8 py-14">
        <div data-aos="zoom-in-down"     data-aos-delay="200" className="left-about pr-0 lg:pr-20">
        ...
        <div data-aos="zoom-in-up"     data-aos-delay="300" className="right-about grid grid-cols-1 sm:grid-cols-2 gap-8 pt-10 sm:pt-0">
          <div className="p-6">
