  ...
  return (
    <div className="pt-0 lg:pt-6 px-2 lg:px-0 overflow-x-hidden f-full lg:h-[100vh] relative">
      <div className="flex flex-col justify-center items-center mb-10">
        <h1 className="text-4xl lg:text-5xl leading-tight font-bold gradient-text py-4">
          {' '}
          My Skills
        </h1>
        <p className="text-[#ddd] text-sm lg:text-lg text-center max-w-sm lg:max-w-xl break-words">
